...
const (
	AccountsService_ListAccounts_FullMethodName      = "/tap.points.v1.AccountsService/ListAccounts"
	AccountsService_GetAccount_FullMethodName        = "/tap.points.v1.AccountsService/GetAccount"
	AccountsService_GetAccountBalance_FullMethodName = "/tap.points.v1.AccountsService/GetAccountBalance"
	AccountsService_CreateAccount_FullMethodName     = "/tap.points.v1.AccountsService/CreateAccount"
)
...
func (c *accountsServiceClient) GetAccountBalance(ctx context.Context, in *GetAccountBalanceRequest, opts ...grpc.CallOption) (*GetAccountBalanceResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountsService_GetAccountBalance_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsServiceClient) CreateAccount(ctx context.Context, in *CreateAccountRequest, opts ...grpc.CallOption) (*CreateAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, AccountsService_CreateAccount_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountsService_GetAccountBalance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountsService_GetAccountBalance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
