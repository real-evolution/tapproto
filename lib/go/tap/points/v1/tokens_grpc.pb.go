...
const (
	TokensService_ListTokens_FullMethodName  = "/tap.points.v1.TokensService/ListTokens"
	TokensService_GetToken_FullMethodName    = "/tap.points.v1.TokensService/GetToken"
	TokensService_CreateToken_FullMethodName = "/tap.points.v1.TokensService/CreateToken"
	TokensService_UpdateToken_FullMethodName = "/tap.points.v1.TokensService/UpdateToken"
	TokensService_DeleteToken_FullMethodName = "/tap.points.v1.TokensService/DeleteToken"
)
...
func (c *tokensServiceClient) ListTokens(ctx context.Context, in *ListTokensRequest, opts ...grpc.CallOption) (*ListTokensResponse, error) {
	...
	err := c.cc.Invoke(ctx, TokensService_ListTokens_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokensServiceClient) GetToken(ctx context.Context, in *GetTokenRequest, opts ...grpc.CallOption) (*GetTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, TokensService_GetToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokensServiceClient) UpdateToken(ctx context.Context, in *UpdateTokenRequest, opts ...grpc.CallOption) (*UpdateTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, TokensService_UpdateToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tokensServiceClient) DeleteToken(ctx context.Context, in *DeleteTokenRequest, opts ...grpc.CallOption) (*DeleteTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, TokensService_DeleteToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TokensService_DeleteToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TokensService_DeleteToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
