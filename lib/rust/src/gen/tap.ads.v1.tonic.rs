...
pub mod ads_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_ad_content(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAdContentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetAdContentResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/tap.ads.v1.AdsService/GetAdContent",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("tap.ads.v1.AdsService", "GetAdContent"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod ads_service_server {
    ...
    pub trait AdsService: Send + Sync + 'static {
        ...
        async fn get_ad_content(
            &self,
            request: tonic::Request<super::GetAdContentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetAdContentResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/tap.ads.v1.AdsService/GetAdContent" => {
                    #[allow(non_camel_case_types)]
                    struct GetAdContentSvc<T: AdsService>(pub Arc<T>);
                    impl<
                        T: AdsService,
                    > tonic::server::UnaryService<super::GetAdContentRequest>
                    for GetAdContentSvc<T> {
                        type Response = super::GetAdContentResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AdsService>::get_ad_content(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetAdContentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
